...
window.customElements.define('nav-bar', MyNavbar); 
...
class MyFooter extends HTMLElement { // source : https://stackoverflow.com/questions/69961205/insert-header-and-footer-on-all-webpages-using-javascript
    connectedCallback() {              // https://developer.mozilla.org/en-US/docs/Web/Web_Components
        ...
        <div class="main">
            ...
            <ul>
                <li>
                    <a href="https://www.twitter.com/" target = "_blank"><img src="image/logo/twitter.png" alt="Twitter" /></a>
                </li>
                <li>
                    <a href="https://www.youtube.com/" target = "_blank"><img src="image/logo/youtube.png" alt="YouTube" /></a>
                </li>
                <li>
                    <a href="https://www.instagram.com/" target = "_blank"><img src="image/logo/instagram.png" alt="Instagram" /></a>
                </li>
            </ul>
            </div>
        </div>
