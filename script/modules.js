    ...
    connectedCallback() {              // https://developer.mozilla.org/en-US/docs/Web/Web_Components
        ...
        <div class="main">
            ...
            <ul>
                ...
                <li>
                    <a href="https://www.youtube.com/watch?v=8myYyMg1fFE"  target = "_about"><img src="../../image/logo/youtube.png" alt="YouTube" /></a>
                </li>
                <li>
    ...
    <nav>
        ...
        <div class="dropdown">
            ...
            <div class="dropdown-content">
                ...
                <a href="sumatra.html">SUMATRA</a>
                <a href="xishuangbanna.html">XISHUANGBANNA</a>
            </div>
        </div>
